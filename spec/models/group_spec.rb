...
RSpec.describe Group, type: :model do
  ...
  context 'with simple' do
    it 'creates groups at the last position' do
      group1 = index.groups.create!(name: 'Group 1')
      group2 = index.groups.create!(name: 'Group 2')
      expect(group1.position).to eq 1
      expect(group2.position).to eq 2
    end
    it 'creates subgroups at the last position' do
      group1 = index.groups.create!(name: 'Group 1')
      group2 = group1.subgroups.create!(name: 'Group 2')
      group3 = group1.subgroups.create!(name: 'Group 2')
    ...
    it 'handles positions correctly when moving groups' do
      group1 = index.groups.create!(name: 'Group 1')
      group2 = index.groups.create!(name: 'Group 2')
      group3 = group1.subgroups.create!(name: 'Group 3')
      group4 = group1.subgroups.create!(name: 'Group 4')
      group5 = group1.subgroups.create!(name: 'Group 5')
      group6 = group2.subgroups.create!(name: 'Group 6')
      group7 = group2.subgroups.create!(name: 'Group 7')
      group8 = group2.subgroups.create!(name: 'Group 8')
      ...
      expect(group2.reload.subgroups).to include group4
    end
    it 'checks groups and subgroups correctly' do
      group1 = index.groups.create!(name: 'Group 1')
      group2 = index.groups.create!(name: 'Group 2')
      group3 = group1.subgroups.create!(name: 'Group 3')
      group4 = group1.subgroups.create!(name: 'Group 4')
